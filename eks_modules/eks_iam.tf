...
resource "aws_iam_role" "eks-cluster-role" {
  name = "${var.cluster_name}-${var.env}-eks-role"
...
resource "aws_iam_role" "server-cluster" {
  name = "${var.cluster_name}-${var.env}-server-cluster-role"
...
resource "aws_iam_role_policy_attachment" "server-cluster-AmazonEKSClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.server-cluster.name
}

resource "aws_iam_role_policy_attachment" "server-cluster-AmazonEKSVPCResourceController" {
...
resource "aws_iam_role" "node_group" {
  name = "${var.cluster_name}-${var.env}-node_group-role"
